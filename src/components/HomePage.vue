        ...
        <v-col cols="12" md="9">
          <v-container>
            <v-row class="cardPanel">
              <v-col class="py-0 px-0" cols="12" md="2">
                <v-card
                ...
                >
                  <div class="my-auto mx-2 hidden-md-and-up">
                    <v-avatar color="#5692e8" class="button" size="36">
                      <span class="white--text text-h5">9</span>
                    </v-avatar>
                  </div></v-card
                >
              </v-col>
              <v-col class="py-0 px-0 d-flex" cols="12" md="10">
                <v-card class="cardPanel text-left pa-2" width="100%" flat tile>
                  <h3 class="textContent">Game Title</h3>
                  <p class="textContent">Release Date: DD/MM/YYYY</p>
                  <p class="textContent">
                    Trysail transma durt sea Legs Trysail transma durt sea Legs
                    Trysail transma durt sea Legs Trysail transma durt sea Legs
                    Trysail transma durt sea Legs Trysail transma durt
                  </p>
                </v-card>
            ...
            <v-row class="cardPanel">
              <v-col class="py-0 px-0" cols="12" md="2">
                ...
                >
                  <div class="my-auto mx-2 hidden-md-and-up">
                    <v-avatar color="#5692e8" class="button" size="36">
                      <span class="white--text text-h5">7</span>
                    </v-avatar>
                  </div></v-card
                >
              </v-col>
